...
class _ChatApi implements ChatApi {
  _ChatApi(
    ...
    baseUrl ??= 'https://wawat.tahirguliyev.com/api/v1';
  }
  ...
  Future<ConversationResponse> startChat(Map<String, dynamic> body) async {
    ...
    _data.addAll(body);
    final _options = _setStreamType<ConversationResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ConversationResponse _value;
    try {
      _value = ConversationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<PinResponse> pinConversation(int conversationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PinResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<PinResponse> unpinConversation(int conversationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ArchiveResponse> archiveConversation(int conversationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ArchiveResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ArchiveResponse _value;
    try {
      _value = ArchiveResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ArchiveResponse> unarchiveConversation(int conversationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ArchiveResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/chats/${conversationId}/unarchive',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<DeleteResponse> deleteConversation(int conversationId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BlockResponse> blockUser(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BlockResponse> unblockUser(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
