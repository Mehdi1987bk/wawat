...
import '../modals/auth_required_modal.dart';
import '../modals/login_modal.dart';
import '../modals/registration_modal.dart';

/// Главный экран приложения Wawat
class WawatHomeScreen extends StatefulWidget {
  const WawatHomeScreen({Key? key}) : super(key: key);

  @override
  State<WawatHomeScreen> createState() => _WawatHomeScreenState();
}

class _WawatHomeScreenState extends State<WawatHomeScreen> {
