...
class CourierDetailsBloc extends BaseBloc {
  ...
  Future<PartnerUserResponse> getUserById(int date) =>
      authRepository.getUserById(date);

  Future<void> sendReviews(CreateReviewRequest request) =>
      authRepository.sendReviews(request);

  Future<ReviewsResponse> myAboutReviev() => authRepository.myAboutReviev();

  Future<ReviewsResponse> myAboutLeft() => authRepository.myAboutLeft();
}
