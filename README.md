...
|-----|--------|-------------------|
| Flutter | **3.47.3** | пин в `.fvmrc`; включает Dart 3.13.3, необходимый текущим зависимостям |
...
Дальше все команды — через `fvm flutter`, не через глобальный `flutter`, чтобы
IDE, Xcode и терминал использовали одну закреплённую версию SDK.
